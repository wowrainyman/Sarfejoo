...
<?php
     ...
     $sql = "SELECT * FROM `digikala_product_related` WHERE id=$related_id";
     $result = mysqli_query($link_DB, $sql) or die(mysqli_error($con_rb));
     while ($row = mysqli_fetch_assoc($result)) {
          $sarfejoo_id = $row['sarfejoo_id'];
          $digikala_id = $row['digikala_id'];
     }
?>
...
<div id="pagenation">
     ...
     &nbsp;&nbsp;&nbsp;&nbsp; <b style="color:#ccc;">|</b> &nbsp;&nbsp;&nbsp;&nbsp;
     کل صفحات: <?php echo ceil($site_bot_count/1) ?></span> 

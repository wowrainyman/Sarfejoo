...
if ($local=='1') {
     ...
     $Blog_DB_name= 'manirahn_sarfe_blog';
}
...
$link_Blog_DB = mysqli_connect($DB_host, $DB_user, $DB_pwd, $Blog_DB_name) or die ('Cannot connect to server');
mysqli_set_charset($link_Blog_DB , 'utf8');
if (mysqli_connect_errno()) {
    echo "Failed to connect to MySQL: " . mysqli_connect_error();
}

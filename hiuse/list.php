    ...
    <div class="container">
        <table class="table table-bordered table-hover table-striped">
            ...
            while ($row = mysqli_fetch_assoc($result_select_oc)) {
                ...
                $bot_auto_update = $row['bot_auto_update'];
                ...
                <tr id="<?php echo $id; ?>">
                    ...
                    <td style="width: 150px;">
                        <?php
                        $bot_auto_update_percent = $bot_auto_update/$bot_all;
                        $bot_auto_update_percent = number_format( $bot_auto_update_percent * 100, 0);
                    ...
                    <td style="width: 150px;">
                        <div class="progress">
                            <div class="progress-bar" role="progressbar" aria-valuenow="<?php echo $bot_auto_update; ?>"
                                 aria-valuemin="0" aria-valuemax="<?php echo $bot_all; ?>" style="width:<?php echo $bot_auto_update_percent; ?>%">
                            </div><span class="sr-only">% <?php echo $bot_auto_update_percent; ?> (<?php echo $bot_auto_update; ?>)</span>
                        </div>
                    </td>
                </tr>
            <?php } ?>

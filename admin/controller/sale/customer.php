...
class ControllerSaleCustomer extends Controller
{
    ...
    protected function getList()
    {
        ...
        foreach ($results as $result) {
            ...
            $balance_info = $this->model_sale_customer->getBalance($result['customer_id']);
    ...
    protected function getForm()
    {
        ...
        $this->data['pu_transactions'] = array();

        if (!empty($customer_info)) {
            $results = $this->model_sale_customer->getUserTransactions($this->request->get['customer_id']);
            $this->data['pu_transactions'] = $results;
        }

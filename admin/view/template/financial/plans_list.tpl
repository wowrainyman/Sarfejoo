            ...
            <?php if (isset($plans)) { ?>
                <?php foreach ($plans as $plan) { ?>
                    <tr>
                        ...
                        <td class="left"><input type="text" name="description[<?php echo $plan['id']; ?>]" value="<?php echo $plan['description']; ?>" /></td>
                        <td class="left"><input type="text" name="price[<?php echo $plan['id']; ?>]" value="<?php echo $plan['price']; ?>" /></td>
                        <td class="left"><input type="text" name="enabled[<?php echo $plan['id']; ?>]" value="<?php echo $plan['enabled']; ?>" /></td>
                        <td class="left"><input type="text" name="sort_order[<?php echo $plan['id']; ?>]" value="<?php echo $plan['sort_order']; ?>" /></td>
                        <td class="left"><input type="text" name="is_recommended[<?php echo $plan['id']; ?>]" value="<?php echo $plan['is_recommended']; ?>" /></td>
                    </tr>
                <?php } ?>
            <?php } else { ?>
                <tr>

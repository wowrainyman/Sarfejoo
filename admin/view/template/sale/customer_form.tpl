  ...
  <div class="box">
    ...
    <div class="content">
      <div id="htabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a>
        <?php if ($customer_id) { ?>
        <a href="#tab-history"><?php echo $tab_history; ?></a><a href="#tab-transaction"><?php echo $tab_transaction; ?></a><a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-pu-transaction"><?php echo $tab_pu_transaction; ?></a><a href="#tab-subprofiles"><?php echo $tab_subprofiles; ?></a>
        <?php } ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-pu-transaction">
            <table class="list">
                <thead>
                <tr>
                    <td class="left"><?php echo $column_datetime; ?></td>
                    <td class="right"><?php echo $column_transaction_gateway_id; ?></td>
                    <td class="left"><?php echo $column_payment_gateway_id; ?></td>
                    <td class="right"><?php echo $column_value; ?></td>
                    <td class="right"><?php echo $column_successful; ?></td>
                    <td class="right"><?php echo $column_transaction_type; ?></td>
                </tr>
                </thead>
                <tbody>
                <?php if ($pu_transactions) { ?>
                    <?php foreach ($pu_transactions as $pu_transaction) { ?>
                    <tr>
                        <td><?php echo $pu_transaction['datetime']; ?></td>
                        <td><?php echo $pu_transaction['transaction_gateway_id']; ?></td>
                        <td><?php echo $pu_transaction['payment_gateway_id']; ?></td>
                        <td><?php echo $pu_transaction['value']; ?></td>
                        <td><?php echo $pu_transaction['successful']; ?></td>
                        <td><?php echo $pu_transaction['transaction_type']; ?></td>
                    </tr>
                    <?php } ?>
                <?php } else { ?>
                <tr>
          ...
          <div id="tab-subprofiles">
              <table class="list">
                  ...
                  <tr>
                      ...
                      <td class="left"><?php echo $column_is_payed; ?></td>
                      <td class="left"><?php echo $column_rate; ?></td>

      ...
      <form action="<?php echo $form_action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
            ...
            <tr>
              ...
              <td class="left"><?php if ($sort == 'tab1.name') { ?>
                ...
                <td class="left"><?php if ($sort == 'tab1.price') { ?>
                    ...
                    <?php } ?></td>
                <td class="left"><?php if ($sort == 'tab1.views') { ?>
          ...
          <tbody>
            ...
            <?php if (isset($byviews_plan)) { ?>
                <?php foreach ($byviews_plan as $byview_plan) { ?>
                    <tr>
                        <td class="left"><input type="text" name="id[<?php echo $byview_plan['id']; ?>]" value="<?php echo $byview_plan['id']; ?>" /></td>
                      <td class="left"><input type="text" name="name[<?php echo $byview_plan['id']; ?>]" value="<?php echo $byview_plan['name']; ?>" /></td>
                        <td class="left"><input type="text" name="enable[<?php echo $byview_plan['id']; ?>]" value="<?php echo $byview_plan['enable']; ?>" /></td>
                        <td class="left"><input type="text" name="sort_order[<?php echo $byview_plan['id']; ?>]" value="<?php echo $byview_plan['sort_order']; ?>" /></td>
                        <td class="left"><input type="text" name="price[<?php echo $byview_plan['id']; ?>]" value="<?php echo $byview_plan['price']; ?>" /></td>
                        <td class="left"><input type="text" name="views[<?php echo $byview_plan['id']; ?>]" value="<?php echo $byview_plan['views']; ?>" /></td>
                    </tr>
                <?php } ?>
            <?php } else { ?>
                <tr>
...
function filter() {
	url = 'index.php?route=ad/plan_byview&token=<?php echo $token; ?>';

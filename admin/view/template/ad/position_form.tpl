        ...
        <div id="tab-general">
            <table class="form">
              <tr>
                ...
                <tr>
                    <td><span class="required">*</span> <?php echo $entry_byclick_plans; ?></td>
                    <td><input type="text" name="byclick_plans" value="" />
                </tr>
                <tr>
                    <td><span class="required">*</span> <?php echo $entry_byview_plans; ?></td>
                    <td><input type="text" name="byview_plans" value="" />
                </tr>
                <tr>
                    <td><span class="required">*</span> <?php echo $entry_bytime_plans; ?></td>
                    <td><input type="text" name="bytime_plans" value="" />
                </tr>
                <tr>
                    <td><span class="required">*</span> <?php echo $entry_related_groups_id; ?></td>
                    <td><input type="text" name="related_groups_id" value="" />
                </tr>
                <tr>
                    <td><span class="required">*</span> <?php echo $entry_factor; ?></td>
                    <td><input type="text" name="factor" value="" />
                </tr>
            </table>
          </div>
        </div>

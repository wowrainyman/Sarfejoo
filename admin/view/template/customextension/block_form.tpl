          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td><input type="text" name="att_name" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name'] : ''; ?>" />
                    <input type="hidden" name="attribute_id" value="0" /></td>
              </tr>
              <tr>
                <td><?php echo $entry_block_name; ?></td>
                <td><input type="text" name="block_name" id="" value=""></td>
              </tr>
            </table>
          </div>
          <?php } ?>

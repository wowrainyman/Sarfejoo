            ...
            <table class="form">
              <tr>
                ...
                <td><input type="text" name="name" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name'] : ''; ?>" />
                    <input type="hidden" name="block_id" value="0" /></td>
              </tr>
              <tr>
                <td><?php echo $text_subattribute_name; ?></td>
                <td><input type="text" name="subattribute_name" id="" value=""></td>
              </tr>
                <tr>
...
$.widget('custom.catcomplete', $.ui.autocomplete, {
    ...
    $('input[name=\'name\']').autocomplete({
        ...
        source: function(request, response) {
            $.ajax({
                url: 'index.php?route=customextension/block_attribute/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request.term),
                dataType: 'json',
        ...
        select: function(event, ui) {
            ...
            $('input[name=\'block_id\']').attr('value', ui.item.value);

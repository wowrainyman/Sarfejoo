      ...
      <form action="<?php echo $form_action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            ...
            <?php if (isset($plan_onces)) { ?>
                <?php foreach ($plan_onces as $plan_once) { ?>
                    <tr>
                      <td class="left"><input type="text" name="name[<?php echo $plan_once['id']; ?>]" value="<?php echo $plan_once['name']; ?>" /></td>
                      <td class="left"><input type="text" name="price[<?php echo $plan_once['id']; ?>]" value="<?php echo $plan_once['price']; ?>" /></td>
                        <td class="left"><input type="text" name="available[<?php echo $plan_once['id']; ?>]" value="<?php echo $plan_once['available']; ?>" /></td>
                        <td class="left"><input type="text" name="target[<?php echo $plan_once['id']; ?>]" value="<?php echo $plan_once['target']; ?>" /></td>
                        <td class="left"><input type="text" name="description[<?php echo $plan_once['id']; ?>]" value="<?php echo $plan_once['description']; ?>" /></td>
                        <td class="left"><input type="text" name="sort_order[<?php echo $plan_once['id']; ?>]" value="<?php echo $plan_once['sort_order']; ?>" /></td>
                    </tr>
                <?php } ?>
            <?php } else { ?>
                <tr>

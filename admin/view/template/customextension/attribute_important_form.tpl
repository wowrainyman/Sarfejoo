          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td>
                    <input type="text" name="attribute_name" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name'] : ''; ?>" />
              ...
              <tr>
                  ...
                  <td>
                      <input type="text" name="product_name" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name'] : ''; ?>" />
...
$.widget('custom.catcomplete', $.ui.autocomplete, {
    ...
    $('input[name=\'attribute_name\']').autocomplete({
        ...
        select: function(event, ui) {
            $('input[name=\'attribute_name\']').attr('value', ui.item.label);

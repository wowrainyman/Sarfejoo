            ...
            <table class="form">
                <thead>
                    <tr>
                        ...
                        <td><?php echo $text_sms; ?></td>
                    </tr>
                </thead>
                    <?php foreach ($subPlans as $subPlan) { ?>
                        <tr>
                            <td> <?php echo $subPlan['name']; ?></td>
                            <td>
                                <textarea cols="40" rows="6" type="text" name="text[<?php echo $subPlan['id']; ?>]" ><?php echo $subPlan['text']; ?></textarea>
                            </td>
                            <td>
                                <textarea cols="40" rows="6" type="text" name="text_sms[<?php echo $subPlan['id']; ?>]" ><?php echo $subPlan['text_sms']; ?></textarea>
                            </td>
                        </tr>
                    <?php } ?>
            </table>

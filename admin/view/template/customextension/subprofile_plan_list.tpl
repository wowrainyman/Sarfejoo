        ...
        <table class="list">
          <thead>
            <tr>
                ...
                <td><?php echo $column_is_product; ?></td>
                <td></td>
            </tr>
          </thead>
          <tbody>
                ...
                <?php foreach ($plans as $plan) { ?>
                    <tr>
                      ...
                      <td class="left"><input type="text" name="name[<?php echo $plan['id']; ?>]" value="<?php echo $plan['name']; ?>" /></td>
                        ...
                        <td class="left"><input type="text" name="is_product[<?php echo $plan['id']; ?>]" value="<?php echo $plan['is_product']; ?>" /></td>
                    </tr>
                <?php } ?>
            <?php } else { ?>
                <tr>
...
function filter() {
	url = 'index.php?route=customextension/subprofile_plan&token=<?php echo $token; ?>';

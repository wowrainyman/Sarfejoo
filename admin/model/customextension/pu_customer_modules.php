...
class ModelCustomextensionPuCustomerModules extends Model {
    public function getTotalModules($data = array()){
        ...
        $sql = "SELECT COUNT(DISTINCT tab1.id) AS total FROM $pu_database_name.pu_customer_module tab1 WHERE 1";
    ...
    public function getModules($data){
        ...
        $sql = "SELECT * FROM $pu_database_name.pu_customer_module tab1 WHERE 1";
    ...
    public function UpdateName($id,$value) {
        ...
        $exist = false;
        $sql_select_string = "SELECT * FROM `pu_customer_module` WHERE `id` = $id";
        ...
        if ($exist) {
            $sql_update_string = "UPDATE `pu_customer_module` SET " .
                "`name`='$value'" .
                " WHERE `id` = $id";
        ...
        $sort_order)
    {
        $pu_database_name = $GLOBALS['pu_database_name'];
        $con_PU_db = $GLOBALS['con_PU_db'];
        $sql_insert_string = "INSERT INTO $pu_database_name.pu_customer_module" .
            "(`name`, `price`, `duration`, `description`, `enabled`, `sort_order`)" .
            " VALUES ('$name', '$price', '$duration', '$description', '$enabled', '$sort_order');";

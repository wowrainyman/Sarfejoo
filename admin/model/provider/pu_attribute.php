...
class ModelProviderPuAttribute extends Model
{
    ...
    {
        $query = "SELECT * FROM sarfe_oc." . DB_PREFIX . "attribute a ,sarfe_oc." . DB_PREFIX . "attribute_description ad, sarfe_pu.pu_attributetype ac WHERE a.attribute_id = '" . (int)$attribute_id . "' AND a.attribute_id = ad.attribute_id AND a.attribute_id = ac.attribute_id";
        $con_PU_db = $GLOBALS['con_PU_db'];

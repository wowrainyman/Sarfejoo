...
<?php echo $content_top; ?>
    <div id="compareblock" class="compareDiv">
        <ul id="compareItems">
            <?php foreach ($product_infos as $product_info) { ?>
            <li id="cmp<?php echo $product_info['product_id']?>"><img align="center" width="50" height="50" src="<?php echo $product_info['thumb']?>" /><img onclick="removeCompare(<?php echo $product_info['product_id']?>)" src="catalog/view/theme/default/image/close.png" alt="" class="close" /></li>
            <?php } ?>
        </ul>

...
<?php echo $content_top; ?>
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-attribute"><?php echo $tab_attribute; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><div id="product-category" class="scrollbox">
                  ...
                  <div id="product-category<?php echo $product_category['category_id']; ?>" class="<?php echo $class; ?>"><?php echo $product_category['name']; ?><img src="catalog/view/theme/default/image/delete.png" alt="" />
            ...
            <tr>
              ...
              <td><div id="product-related" class="scrollbox">
                  ...
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="product-related<?php echo $product_related['product_id']; ?>" class="<?php echo $class; ?>"> <?php echo $product_related['name']; ?><img src="catalog/view/theme/default/image/delete.png" alt="" />
        ...
        <div id="tab-attribute">
          <table id="attribute" class="list">
            <thead>
              <tr>
                <td class=""><?php echo $entry_attribute; ?></td>
                <td class=""><?php echo $entry_text; ?></td>
                <td></td>
              </tr>
            </thead>
            <?php $attribute_row = 0; ?>
            ...
            <tbody id="attribute-row<?php echo $attribute_row; ?>">
              <tr>
                <td class=""><input type="text" name="product_attribute[<?php echo $attribute_row; ?>][name]" value="<?php echo $product_attribute['name']; ?>" />
                  <input type="hidden" name="product_attribute[<?php echo $attribute_row; ?>][attribute_id]" value="<?php echo $product_attribute['attribute_id']; ?>" /></td>
                <td class=""><?php foreach ($languages as $language) { ?>
                  ...
                  <?php } ?></td>
                <td class=""><a onclick="$('#attribute-row<?php echo $attribute_row; ?>').remove();" class="button"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $attribute_row++; ?>
            <?php } ?>
...
$('input[name=\'manufacturer\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: 'index.php?route=provider/manufacturer/autocomplete&filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
...
$('input[name=\'category\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: 'index.php?route=provider/category/autocomplete&filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: 'index.php?route=provider/filter/autocomplete&filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
	...
	select: function(event, ui) {
		...
		$('#product-filter').append('<div id="product-filter' + ui.item.value + '">' + ui.item.label + '<img src="catalog/view/theme/default/image/delete.png" alt="" /><input type="hidden" name="product_filter[]" value="' + ui.item.value + '" /></div>');
...
$('input[name=\'download\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: 'index.php?route=provider/download/autocomplete&filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
	...
	select: function(event, ui) {
		...
		$('#product-download').append('<div id="product-download' + ui.item.value + '">' + ui.item.label + '<img src="catalog/view/theme/default/image/delete.png" alt="" /><input type="hidden" name="product_download[]" value="' + ui.item.value + '" /></div>');
...
$('input[name=\'related\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: 'index.php?route=provider/product/autocomplete&filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
	...
	select: function(event, ui) {
		...
		$('#product-related').append('<div id="product-related' + ui.item.value + '">' + ui.item.label + '<img src="catalog/view/theme/default/image/delete.png" alt="" /><input type="hidden" name="product_related[]" value="' + ui.item.value + '" /></div>');

                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div id="compare-place-2">
                                                <?php if(isset($compare_products)&&count($compare_products)>1) { ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6" style="float: right;">
                                            <div id="compare-place-3">
                                                <?php if(isset($compare_products)&&count($compare_products)>2) { ?>
                                        ...
                                        <div class="col-md-6">
                                            <div id="compare-place-4">
                                                <?php if(isset($compare_products)&&count($compare_products)>3) { ?>
                            ...
                            <div class="btn-group" style="float: right;right: 450px;position: absolute;width: 200px;">
                                ...
                                <div class="dropdown-menu" style="width: 895px;right:-450px;opacity: 0.9;background-color: #F4F4F4;color: #000000;" role="menu">
                                    <div class="row">
                                        <div class="col-md-6" style="float: right;">
                                            <div id="fav-place-1">
                                                <?php if(isset($wish_products)&&count($wish_products)>0) { ?>
                                        ...
                                        <div class="col-md-6">
                                            <div id="fav-place-2">
                                                <?php if(isset($wish_products)&&count($wish_products)>1) { ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6" style="float: right;">
                                            <div id="fav-place-3">
                                                <?php if(isset($wish_products)&&count($wish_products)>2) { ?>
                                        ...
                                        <div class="col-md-6">
                                            <div id="fav-place-4">
                                                <?php if(isset($wish_products)&&count($wish_products)>3) { ?>

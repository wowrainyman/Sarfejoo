    ...
    <ul class="left" style="display: none;">
          ...
          <li><a class="parent"><?php echo $text_attribute; ?></a>
            <ul>
              ...
              <li><a href="<?php echo $attribute_group; ?>"><?php echo $text_attribute_group; ?></a></li>
                <li><a href="<?php echo $attribute_important; ?>"><?php echo $text_attribute_important; ?></a></li>
            </ul>
          </li>
            <li><a class="parent"><?php echo $text_block; ?></a>
                <ul>
                    <li><a href="<?php echo $block; ?>"><?php echo $text_block; ?></a></li>
                    <li><a href="<?php echo $block_attribute; ?>"><?php echo $text_block_attribute; ?></a></li>
                    <li><a href="<?php echo $block_attribute_value; ?>"><?php echo $text_block_attribute_value; ?></a></li>
                </ul>
            </li>
            <li><a class="parent"><?php echo $text_plan; ?></a>
                <ul>
                    <li><a href="<?php echo $plan_periodic; ?>"><?php echo $text_plan_periodic; ?></a></li>
                    <li><a href="<?php echo $plan_once; ?>"><?php echo $text_plan_once; ?></a></li>
                    <li><a href="<?php echo $provider_plan; ?>"><?php echo $text_provider_plan; ?></a></li>
                    <li><a href="<?php echo $subprofile_plan; ?>"><?php echo $text_subprofile_plan; ?></a></li>
                </ul>
            </li>
            <li><a href="<?php echo $rating; ?>"><?php echo $text_rating; ?></a></li>
            <li><a href="<?php echo $my_setting; ?>"><?php echo $text_my_setting; ?></a></li>
            <li><a href="<?php echo $subprofile_comment; ?>"><?php echo $text_subprofile_comment; ?></a></li>
            <li><a href="<?php echo $newsletter_plan; ?>"><?php echo $text_newsletter_plan; ?></a></li>
      ...
      <li id="sale"><a class="top"><?php echo $text_sale; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $subprofile; ?>"><?php echo $text_subprofile; ?></a></li>
      ...
      <li id="reports"><a class="top"><?php echo $text_reports; ?></a>
        ...
        <li id="advertising"><a class="top"><?php echo $text_advertising; ?></a>
            <ul>
                <li><a  class="parent"><?php echo $text_ad_plans; ?></a>
                    <ul>
                        <li><a href="<?php echo $ad_plan_byclick; ?>"><?php echo $text_ad_plan_byclick; ?></a></li>
                        <li><a href="<?php echo $ad_plan_byview; ?>"><?php echo $text_ad_plan_byview; ?></a></li>
                        <li><a href="<?php echo $ad_plan_bytime; ?>"><?php echo $text_ad_plan_bytime; ?></a></li>
                    </ul>
                </li>
                <li><a href="<?php echo $ad_position; ?>"><?php echo $text_ad_position; ?></a></li>
